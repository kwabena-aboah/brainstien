                ...
                <div class="col-md-12">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h3 class="panel-heading">Upload Photos:</h3>
                    </div>
                    <div class="panel-body">
					 <form  method="post" enctype="multipart/form-data" class="form">
					  Select Picture
					 <input type="file" name="image" class="font form-control"> 
					  </br>
					 	<input name="member_id" class="form-control" type="hidden"  value="<?php echo $_SESSION['SESS_MEMBER_ID'];?>"/>
					    <input type="submit" value="Upload" class="greenButton btn">
