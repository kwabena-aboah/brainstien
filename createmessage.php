                ...
                <div class="col-md-12">
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h3 class="panel-title">Message Wall</h3>
                    </div>
              	...
              	<form name="" method="post" class="form">
						...
						<?php
							...
							?>
						<input class="t form-control" type="hidden" name="from" id="inputtype" value="<?php echo $row['member_id']; ?>">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<input class="t form-control" type="text"  id="inputtype" value="<?php echo $row['FirstName']; echo'&nbsp;'; echo $row['LastName']; ?>">
						</br>

						<label for="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To:</label>
						<?php 
							$member_id=$_SESSION['SESS_MEMBER_ID'];							
							...
							echo "&nbsp;&nbsp;&nbsp;&nbsp;<select name='sendto' class='t form-control' ;'>";	
							if ($num_rows != 0 ){
								while($row = mysql_fetch_array($post)){
									...
									if($myfriend == $member_id){
										...
										echo '<option class="form-control" value = '.$friendsa['member_id'].'> '.$friendsa['FirstName'].' '.$friendsa['LastName'].'</option>';	
									}else{
						...
						?>
						<label for="left">&nbsp;&nbsp;&nbsp;&nbsp;Message:</label>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;<textarea cols="35" rows="5" name="message" class="form-control"></textarea></p>
						
						<p align="left">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" id="inputsubmit" class="greenButton form-control" name="send" value="Send">
						<br />
						</p>
							<?php 
